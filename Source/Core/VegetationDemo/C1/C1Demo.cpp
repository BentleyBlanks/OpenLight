...
const char* GlobalFresnelMaterialName[] = {
	"Water",
	"PlasticLow",
	"PlasticHigh",
	"Glass",
...
// Linear RGB
XMFLOAT4 GlobalFresnelMaterial[] = { XMFLOAT4(0.02f,0.02f,0.02f,1.f),
									XMFLOAT4(0.03f,0.03f,0.03f,1.f),
									XMFLOAT4(0.05f,0.05f,0.05f,1.f),
									XMFLOAT4(0.08f,0.08f,0.08f,1.f),
									XMFLOAT4(0.17f,0.17f,0.17f,1.f),
									XMFLOAT4(0.56f,0.57f,0.58f,1.f),
									XMFLOAT4(0.95f,0.64f,0.54f,1.f),
									XMFLOAT4(1.00f,0.71f,0.29f,1.f),
									XMFLOAT4(0.91f,0.92f,0.92f,1.f),
									XMFLOAT4(0.95F,0.93F,0.88F,1.f) };
			...
			else
			{
				...
				if (ImGui::BeginTabBar("##Tabs", ImGuiTabBarFlags_None))
				{
					...
					if (ImGui::BeginTabItem("Material"))
					{
						...
						ImGui::SameLine();
						if (ImGui::Combo("Default", &gSelectedFresnelIndex, GlobalFresnelMaterialName, EFresnelMaterialNameCount))
						{
							mPBRMeshs[0]->materialChanged = true;
							mPBRMeshs[0]->material.materialAlbedo = GlobalFresnelMaterial[gSelectedFresnelIndex];
						}
