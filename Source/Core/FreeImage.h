...
#define EXR_LC				0x0040	//! save images with one luminance and two cD3DHRoma channels, rather than as RGB (lossy compression)
...
#define JPEG_SUBSAMPLING_411 0x1000		//! save with high 4x1 cD3DHRoma subsampling (4:1:1) 
#define JPEG_SUBSAMPLING_420 0x4000		//! save with medium 2x2 medium cD3DHRoma subsampling (4:2:0) - default value
#define JPEG_SUBSAMPLING_422 0x8000		//! save with low 2x1 cD3DHRoma subsampling (4:2:2) 
#define JPEG_SUBSAMPLING_444 0x10000	//! save with no cD3DHRoma subsampling (4:4:4)
...
#define JXR_DEFAULT			0		//! save with quality 80 and no cD3DHRoma subsampling (4:4:4)
...
DLL_API FIBITMAP *DLL_CALLCONV FreeImage_TD3DHReshold(FIBITMAP *dib, BYTE T);
